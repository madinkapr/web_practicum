...
import { SAVE_USER, SAVE_SESSION, GET_SESSION, DELETE_SESSION } from "./db/query.js"
...
fastify.get("/auth/callback", async (request, reply) => {
	...
	await query(SAVE_USER, userId, userInfo.name, userInfo.email, userInfo.picture)
...
fastify.get("/me", async (request, reply) => {
	...
	const rows = await query(GET_SESSION, sessionId)
...
fastify.post("/logout", async (request, reply) => {
	...
	if (sessionId) {
		...
		await query(DELETE_SESSION, sessionId)
	}
